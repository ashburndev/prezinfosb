...
public class President {
  ...
  @Override
	public String toString() {
		return "President [id=" + id + ", firstName=" + firstName + ", middleName=" + middleName + ", lastName="
				+ lastName + ", politicalParty=" + politicalParty + ", firstInaugDate=" + firstInaugDate
				+ ", firstInaugAddress=" + firstInaugAddress + ", elections=" + elections + ", terms=" + terms + "]";
	}
